...
- **React**: See [`../../tsh-implementing-frontend/references/react-patterns.md`](../../tsh-implementing-frontend/references/react-patterns.md) — hooks, JSX composition, memoization APIs.
