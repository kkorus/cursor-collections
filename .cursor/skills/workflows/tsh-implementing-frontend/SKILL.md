...
- If no verification workflow is active, load `tsh-ui-verifying` to compare the implementation against the Figma design.
...
- `tsh-ui-verifying` — verifying implementation against Figma designs
