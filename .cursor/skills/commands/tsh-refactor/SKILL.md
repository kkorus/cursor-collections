...
- `tsh-code-reviewing` — post-refactor quality gate (step 5): verify no regressions, code quality standards met, no new smells introduced
...
- `tsh-code-reviewing` — post-refactor quality gate
