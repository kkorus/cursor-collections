...
- Read [references/code-reviewing.md](references/code-reviewing.md) — structured code review process (correctness, quality, security, testing, best practices, scalability)
