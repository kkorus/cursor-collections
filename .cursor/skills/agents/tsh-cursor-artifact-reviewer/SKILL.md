...
**Responsibilities:**
- Evaluate Cursor customization artifacts (`SKILL.md`, `.mdc rules`, `.prompt.md`) against quality criteria provided in the delegation prompt
